        ...
        <div class="d-flex gap-2 align-items-center">
          ...
          <div class="dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="fileMenuDropdown">
              ...
              <li><a class="dropdown-item" href="#" @click.prevent="showTemplates = true">{{ t('templates') }}</a></li>
              <li><a class="dropdown-item" href="#" @click.prevent="showWizard = true">{{ t('wizard') }}</a></li>
              <li><hr class="dropdown-divider"></li>
          ...
          <button class="btn btn-sm btn-outline-secondary" @click="showNodeSelector = !showNodeSelector" :title="t('nodeSelector')">
            ◇
          </button>
